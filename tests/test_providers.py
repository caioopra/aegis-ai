...
class TestOllamaChatProvider:
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_returns_content(self, mock_chat):
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_prepends_system_prompt(self, mock_chat):
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_without_system_prompt(self, mock_chat):
        mock_chat.return_value = {"message": {"content": "ok"}}
        provider = OllamaChatProvider(model="mistral")
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_passes_model(self, mock_chat):
        mock_chat.return_value = {"message": {"content": "ok"}}
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_passes_temperature(self, mock_chat):
        mock_chat.return_value = {"message": {"content": "ok"}}
        provider = OllamaChatProvider(model="mistral")
        provider.chat(
            messages=[{"role": "user", "content": "Hi"}],
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_json_mode_sets_format(self, mock_chat):
    ...
    @patch("aegis.providers.ollama._ollama.chat")
    def test_chat_no_json_mode_omits_format(self, mock_chat):
        mock_chat.return_value = {"message": {"content": "ok"}}
        provider = OllamaChatProvider(model="mistral")
        provider.chat(
            messages=[{"role": "user", "content": "Hi"}],
...
class TestOllamaEmbedProvider:
    ...
    @patch("aegis.providers.ollama._ollama.embed")
    ...
    @patch("aegis.providers.ollama._ollama.embed")
    def test_embed_passes_model(self, mock_embed):
    ...
    def test_embedding_dim_returns_configured_value(self):
