...
STOP_WORDS: frozenset[str] = frozenset({
    ...
    "e", "em", "é", "era", "esse", "essa", "este", "esta", "eu", "foi",
    "já", "lhe", "mais", "mas", "me", "meu", "na", "nas", "no", "nos",
    "não", "nem", "nós", "o", "os", "ou", "para", "pela", "pelas", "pelo",
    "pelos", "por", "que", "qual", "quando", "se", "sem", "ser", "seu",
    "sua", "são", "também", "te", "tem", "um", "uma", "uns", "você",
})
